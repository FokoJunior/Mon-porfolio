        ...
        <main class="main">
            ...
            <section class="home section" id="home">
                <div class="home_container cantainer grid">
                    <div class="home_content grid">
                        ...
                        <div class="home_data">
                            <h2 class="home_title"><?php include('./assets/config/date.php');?>, J'suis Foko_Junior <span>I</span> </h2>
                            <h3 class="home_subtitle">Développeur Fullstack,</h3>
                            <p class="home_description">Passionné par la programmation, 
                                les nouvelles technologies et l'intelligence artificielle. Fort d'une solide expérience dans le développement 
                                d'applications web, je maîtrise à la fois le Front-end et le Back-end, avec un intérêt particulier pour la
                                création de solutions innovantes et optimisées. Toujours à l'affût des dernières
                                tendances du développement et de l'IA, je suis motivé par la 
                                résolution de problèmes complexes et l'amélioration continue de mes compétences techniques.</p>
            ...
            <section class="about section" id="about">
                ...
                <div class="about_container container grid">
                    <img src="assets/img/bg2.png" alt="" class="about_img">

                    <div class="about_data">
                        <p class="about_description"> Je développe des applications web et des sites web, 
                            qu'ils soient statiques ou dynamiques, pour des entreprises. 
                            Passionné par la programmation et l'intelligence artificielle, 
                            je m'efforce de créer des solutions efficaces et adaptées aux besoins de mes clients.
                        </p>
                         ...
                         <div class="about_info">
                            ...
                            <div>
                                <span class="about_info-title">06+</span>
                ...
                <div class="services_container container grid">
                        ...
                        <div class="services_modal-content">
                            ...
                            <ul class="services_modal-services grid">
                                <li class="services_modal-service">
                                    ...
                                    <p>Création de designs de sites web attrayants et ergonomiques.</p>
                                </li>
                                <li class="services_modal-service">
                                    <i class="uil uil-check-circle services_modal-icon"></i>
                                    <p>Développement d'interfaces utilisateur intuitives et fonctionnelles.</p>
                                </li>
                                <li class="services_modal-service">
                                    <i class="uil uil-check-circle services_modal-icon"></i>
                                    <p>Intégration de la charte graphique de votre marque.</p>
                                </li>
                                <li class="services_modal-service">
                                    <i class="uil uil-check-circle services_modal-icon"></i>
                                    <p>Optimisation des designs pour une expérience utilisateur fluide.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="services_content">
                        <div>
                            ...
                            <h3 class="services_title">Développeur <br> Frontend</h3>
                        </div>
                        ...
                        <div class="services_modal">
                            <div class="services_modal-content">
                                <h4 class="services_modal-title">Développeur <br> Frontend</h4>
                                <i class="uil uil-times services_modal-close"></i>

                                <ul class="services_modal-services grid">
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Conception et développement d'interfaces utilisateur intuitives.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Optimisation des performances pour une expérience fluide.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Création de pages web responsives et optimisées pour tous les appareils.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Utilisation des dernières technologies Frontend (HTML, CSS, JavaScript, etc.).</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Optimisation de la performance et de l'accessibilité des sites web.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="services_content">
                        <div>
                            <i class="uil uil-paint-tool services_icon"></i>
                        ...
                        <div class="services_modal">
                            <div class="services_modal-content">
                                ...
                                <ul class="services_modal-services grid">
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Création de logos uniques et sur mesure.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Design de logos qui reflètent l'identité de votre marque.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Utilisation de concepts créatifs pour un impact visuel fort.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Conception professionnelle adaptée à tous types de supports.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="services_content">
                        <div>
                            <i class="uil uil-server services_icon"></i>
                            <h3 class="services_title">Développeur <br> Backend</h3>
                        </div>
                        ...
                        <div class="services_modal">
                            <div class="services_modal-content">
                                <h4 class="services_modal-title">Développeur <br> Backend</h4>
                                <i class="uil uil-times services_modal-close"></i>

                                <ul class="services_modal-services grid">
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Création d'APIs robustes et sécurisées.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                    ...
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Intégration de systèmes tiers pour des fonctionnalités avancées.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Développement de solutions évolutives et maintenables.</p>
                                    </li>
                                    <li class="services_modal-service">
                                        <i class="uil uil-check-circle services_modal-icon"></i>
                                        <p>Implémentation de la sécurité des données et des utilisateurs.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="services_content">
                <div>
                    <i class="uil uil-brain services_icon"></i>
                    <h3 class="services_title">Solutions <br> IA</h3>
                </div>
                ...
                <div class="services_modal">
                    <div class="services_modal-content">
                        <h4 class="services_modal-title">Solutions <br> IA</h4>
                        <i class="uil uil-times services_modal-close"></i>

                        <ul class="services_modal-services grid">
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Développement de modèles d'apprentissage automatique sur mesure.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Intégration d'algorithmes d'IA pour l'automatisation des processus.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Analyse de données et création de systèmes de recommandation.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Développement d'applications intelligentes et prédictives.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Optimisation des performances des systèmes grâce à l'IA.</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="services_content">
                <div>
                    ...
                    <h3 class="services_title">Hébergement <br> Web</h3>
                </div>
                ...
                <div class="services_modal">
                    <div class="services_modal-content">
                        <h4 class="services_modal-title">Hébergement <br> Web</h4>
                        <i class="uil uil-times services_modal-close"></i>

                        <ul class="services_modal-services grid">
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Solutions d'hébergement personnalisées pour tous types de sites.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Serveurs dédiés et VPS pour des performances optimales.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Hébergement cloud pour une évolutivité facile et rapide.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Sauvegardes automatiques et sécurité avancée des données.</p>
                            </li>
                            <li class="services_modal-service">
                                <i class="uil uil-check-circle services_modal-icon"></i>
                                <p>Assistance 24/7 pour résoudre tous vos problèmes d'hébergement.</p>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="portfolio_container container swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="portfolio_content grid swiper-slide">
                            ...
                            <h4 class="portfolio_title">Création de sites web modernes et sur mesure</h4>
                                Je conçois des sites web modernes, dynamiques ou statiques,
                                 avec un design attrayant et des fonctionnalités adaptées à vos besoins.<br>
                                     <b>Transformez vos idées en réalité numérique avec moi </b>!
                            </p>
                        ...
                        <div class="portfolio_content grid swiper-slide">
                            ...
                            <div class="portfolio_data">
                                <h3 class="portfolio_title">Design de logos personnalisés</h3>
                                <p class="portfolio_description">Besoin d'un logo unique et professionnel ? 
                                    Je crée des logos sur mesure, qui reflètent l'identité et les valeurs 
                                    de votre entreprise.<br>
                                    <b>Donnez du caractère à votre marque !</b>
                                </p>
                                <a href="#" class="button button--flex button--small portfolio_button">
                                    Demo
                                    <i class="uil uil-arrow-right button_icon"></i>
                        ...
                        <div class="portfolio_content grid swiper-slide">
                            ...
                            <div class="portfolio_data">
                                <h3 class="portfolio_title">Développement d'applications de gestion sur mesure</h3>
                                <p class="portfolio_description">Optimisez vos processus avec une application de 
                                    gestion personnalisée, adaptée à vos besoins spécifiques. 
                                    Je développe des solutions efficaces et intuitives pour 
                                    simplifier la gestion de votre entreprise. <br>
                                    <b>Améliorez votre productivité dès aujourd'hui !</b>
                                </p>
                         ...
                         <!--==================== PORTFOLIO 3====================-->
                         <div class="portfolio_content grid swiper-slide">
                            <img src="assets/img/ai.jpg" alt="" class="portfolio_img">

                            <div class="portfolio_data">
                                <h3 class="portfolio_title">Solutions d'intelligence artificielle sur mesure</h3>
                                <p class="portfolio_description">OBoostez vos performances avec des solutions 
                                    d'IA personnalisées. J'intègre l'intelligence artificielle pour automatiser 
                                    vos processus, analyser vos données et optimiser vos résultats. <br>
                                    <b>Améliorez votre productivité dès aujourd'hui !</b>
                                </p>
                ...
                <div class="testimonial_container container swiper-container">
                    <div class="swiper-wrapper">
                      ...
                      <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                ...
                                <div>
                                    ...
                                    <span class="testimonial_cilent">Amis</span>
                                </div>
                            </div>

                            <div>
                                <i class="uis uis-star testimonial_icon-star"></i>
                                <i class="uis uis-star testimonial_icon-star"></i>
                                <i class="uis uis-star testimonial_icon-star"></i>
                                <i class="uis uis-star testimonial_icon-star"></i>
                        ...
                        <p class="testimonial_description">Foko est un développeur exceptionnel, capable de transformer 
                            des idées en solutions concrètes et performantes. Son expertise Fullstack se voit dans chaque 
                            projet sur lequel il travaille. Ce qui m'impressionne le plus chez lui, c'est sa passion pour 
                            la programmation et son dévouement à apprendre constamment, en particulier dans le domaine de l'intelligence artificielle. 
                            Travailler avec lui est un plaisir, car il combine compétence technique et attitude positive.
                        </p>
                      ...
                      <div class="testimonial_content swiper-slide">
                        ...
                        <p class="testimonial_description">Travailler avec Foko a été une excellente expérience. 
                            En tant que développeur Fullstack, il a su comprendre mes besoins et proposer des solutions
                             sur mesure qui ont parfaitement répondu à mes attentes. Sa capacité à innover et à intégrer 
                             des technologies comme l'intelligence artificielle a permis d'améliorer considérablement la 
                             performance de mes projets. Foko est toujours à l'écoute, et son engagement à 
                            fournir un travail de qualité fait de lui un professionnel sur qui je peux compter.
                        </p>
                      ...
                      <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                ...
                                <div>
                                    ...
                                    <span class="testimonial_cilent">Collaborateur</span>
                                </div>
                            </div>
                        ...
                        <p class="testimonial_description">Collaborer avec Foko a toujours été une expérience enrichissante. 
                            Son attention aux détails et sa capacité à résoudre des problèmes complexes rapidement en font un 
                            atout dans n'importe quelle équipe. Que ce soit pour des projets web ou des innovations dans l'IA, 
                            il apporte une approche méthodique et créative à tout ce qu'il entreprend. 
                            En plus de ses compétences techniques, Foko est un leader naturel qui inspire ceux qui travaillent avec lui.
                        </p>
            ...
            <div class="footer_bg">
                <div class="footer_container container grid">
                    <div>
                        ...
                        <span class="footer_subtitle">Developper Fullstack</span>
                    </div>
                ...
                <p class="footer_copy">  2022 - <?php echo date('Y'); ?> &copy; Foko_Junior. Tous les droits sont reserves</p>
            </div>
        </footer>
